...
import (
	...
	"log"
	routes "bhatiachahat/user-service/routes"
	utils "bhatiachahat/user-service/utils"
  //  "github.com/bhatiachahat/mongoapi/routes"
	...
	docs "bhatiachahat/user-service/docs"
...
func main() {
	...
	if port==""{
		...
		docs.SwaggerInfo.Title = "Online Shopping App - Users Module"
